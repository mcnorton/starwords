...
**Season 1** — 침략군의 포위를 뚫고 탈출하라.

우주 테마 슈팅과 타자 연습을 결합한 브라우저 게임입니다. 적 함선 위에 표시된 단어를 입력해 함포로 격추하고, 포위망을 돌파해 15개 챌린지를 탈출하세요.

> 스타워즈 영화 시리즈처럼, 부제 **Breakthrough**는 시즌 스토리와 연결됩니다. Season 1의 배경은 침략군의 포위를 뚫고 탈출하는 작전입니다. 클리어 시 **Breakthrough!** 엔딩이 됩니다.
...
- 설치가 끝나면 버튼이 **INSTALLED**로 바뀌고, 홈 화면·앱 목록의 **STAR WORDS** 아이콘으로 실행합니다.
- 한 번 온라인으로 연 뒤에는 캐시된 앱 셸로 **오프라인** 플레이가 가능합니다.
